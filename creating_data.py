...
def main():
    ...
    start_month_and_day = "4/12/"# "05/29/" # use to be 4/12/ before testing value implimented   # CHANGE THE START AND END DATE, AND MAYBE TRY TO FIGURE OUT WHY OLD DATA WORKS BETTER THAN NEW DATA?
